...
const PostDisplay = (post, index) => {
    ...
    postElement.textContent = post.text;const saveBtn = document.getElementById("save-btn");
    ...
    const PostDisplay = (post, index) => {
      ...
      deleteIcon.classList.add("bx", "bx-trash"); // Example using Boxicons class for a trash icon
